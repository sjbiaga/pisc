...
lazy val `ce-main` = (project in file("ce/main"))
  .settings(
    name := "ce Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `ce-main_` = (project in file("ce/main_"))
  .settings(
    name := "ce_ Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `akka-main` = (project in file("akka/main"))
  .settings(
    name := "akka Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `akka-main_` = (project in file("akka/main_"))
  .settings(
    name := "akka_ Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `pekko-main` = (project in file("pekko/main"))
  .settings(
    name := "pekko Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `pekko-main_` = (project in file("pekko/main_"))
  .settings(
    name := "pekko_ Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `fs2-main` = (project in file("fs2/main"))
  .settings(
    name := "fs2 Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `fs2-main_` = (project in file("fs2/main_"))
  .settings(
    name := "fs2_ Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `monix-main` = (project in file("monix/main"))
  .settings(
    name := "monix Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `monix-main_` = (project in file("monix/main_"))
  .settings(
    name := "monix_ Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `zs-main` = (project in file("zs/main"))
  .settings(
    name := "zs Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val `zs-main_` = (project in file("zs/main_"))
  .settings(
    name := "zs_ Polyadic π-Calculus2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
