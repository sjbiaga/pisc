...
ThisBuild / scalaVersion := "3.6.3-RC2"
...
lazy val root = (project in file("."))
  ...
  .settings(
    name := "π-Calculus[transactions]2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
    scalaVersion := "3.6.3-RC2",
    crossScalaVersions ++= Seq("2.13.15", "3.6.3-RC2"),
...
lazy val main = (project in file("main"))
  .settings(
    name := "main π-Calculus[transactions]2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
...
lazy val main_ = (project in file("main_"))
  .settings(
    name := "main_ π-Calculus[transactions]2Scala",
    organization := "sjb.ia.ga",
    organizationName := "sjbiaga",
    version := "1.0",
    maxErrors := 5,
