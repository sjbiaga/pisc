...
object Dependencies {
  ...
  lazy val avroʹ = "io.confluent" % "kafka-avro-serializer" % "8.3.1"
  lazy val rabbitmq = "com.rabbitmq" % "amqp-client" % "5.34.0"
  lazy val amazonsqs = "software.amazon.awssdk" % "sqs" % "2.54.1"
