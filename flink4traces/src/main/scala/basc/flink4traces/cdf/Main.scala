...
object Main:
  ...
  def main(args: Array[String]): Unit =
    ...
    val probabilityThreshold = params.getDouble("window-duration", 0.5)
    ...
    val kafkaSource = KafkaSource.builder[GenericRecord]()
      ...
      .setGroupId("flink-functions4traces-cdf-group")
    ...
    CDFPipeline(tracesStream,
                windowDuration,
                allowedLateness,
                probabilityThreshold,
                kafkaTopic)

    env.execute(s"flink-functions4traces-analytics-cdf")
